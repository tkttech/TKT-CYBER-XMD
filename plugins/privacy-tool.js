...
┃☯︎╭─────────────·๏
┃☯︎┃• blocklist - View blocked users
┃☯︎┃• getbio - Get user's bio
┃☯︎┃• setppall - Set profile pic privacy
┃☯︎┃• setonline - Set online privacy
┃☯︎┃• setpp - Change bot's profile pic
┃☯︎┃• setmyname - Change bot's name
┃☯︎┃• updatebio - Change bot's bio
┃☯︎┃• groupsprivacy - Set group add privacy
┃☯︎┃• getprivacy - View current privacy settings
┃☯︎┃• getpp - Get user's profile picture
┃☯︎┃
┃☯︎┃*Options for privacy commands:*
┃☯︎┃• all - Everyone
┃☯︎┃• contacts - My contacts only
┃☯︎┃• contact_blacklist - Contacts except blocked
┃☯︎┃• none - Nobody
┃☯︎┃• match_last_seen - Match last seen
┃☯︎└───────────┈⊷
╰──────────────┈⊷
*Note:* Most commands are owner-only`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/y4l7la.jpg` }, // Replace with privacy-themed image if available
                caption: privacyMenu,
                contextInfo: {
