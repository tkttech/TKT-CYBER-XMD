...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/izhykf.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'Tᴀғᴀᴅᴢᴡᴀ-ᴛᴋᴛ',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
        ...
        // Send audio
        await conn.sendMessage(from, {
            audio: { url: 'https://files.catbox.moe/0th843.mp3' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
