const {
  ...
  const ownerNumber = ['263718095555']
...
const sessdata = config.SESSION_ID.replace("TKT-CYBER~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*🇿🇼 ℍ𝕖𝕝𝕝𝕠, 𝕋𝕂𝕋-ℂ𝕐𝔹𝔼ℝ-𝕏𝕄𝔻 𝕃𝕖𝕘𝕖𝕟𝕕! ✨*

╭─〔 *🤖 𝐓𝐊𝐓-𝐂𝐘𝐁𝐄𝐑-𝐗𝐌𝐃 𝐁𝐎𝐓* 〕 
├─▸ *𝐒𝐢𝐦𝐩𝐥𝐢𝐜𝐢𝐭𝐲. 𝐒𝐩𝐞𝐞𝐝. 𝐏𝐨𝐰𝐞𝐫. 𝐁𝐘 𝐓𝐤𝐭𝐭𝐞𝐜𝐡 |* 
╰─➤ *𝐘𝐨𝐮𝐫 𝐍𝐞𝐰 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐒𝐢𝐝𝐞𝐤𝐢𝐜𝐤 𝐢𝐬 𝐇𝐞𝐫𝐞!*

*❤️ 𝐓𝐡𝐚𝐧𝐤 𝐲𝐨𝐮 𝐟𝐨𝐫 𝐂𝐡𝐨𝐨𝐬𝐢𝐧𝐠 𝐓𝐊𝐓-𝐂𝐘𝐁𝐄𝐑-𝐗𝐌𝐃!*

╭──〔 🔗 *𝐐𝐮𝐢𝐜𝐤 𝐋𝐢𝐧𝐤𝐬* 〕 
├─ 📢 *𝐉𝐨𝐢𝐧 𝐎𝐮𝐫 𝐂𝐡𝐚𝐧𝐧𝐞𝐥:* 
│ 𝐂𝐥𝐢𝐜𝐤 [**𝐇𝐞𝐫𝐞**](https://whatsapp.com/channel/0029Vb5vbMM0LKZJi9k4ED1a) 𝐭𝐨 𝐣𝐨𝐢𝐧! 
├─ ⭐ *𝐆𝐢𝐯𝐞 𝐔𝐬 𝐚 𝐒𝐭𝐚𝐫:* 
│ 𝐒𝐭𝐚𝐫 𝐔𝐬 [**𝐇𝐞𝐫𝐞**](https://github.com/tkttech/TKT-CYBER-XMD)!
╰─🛠️ *Prefix:* \`${prefix}\`

> _© 𝐃𝚵𝛁𝚵𝐋𝚯𝚸𝚵𝚪 𝒯𝒦𝒯-𝒯𝐸𝒞𝐻_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/izhykf.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('263718095555','263781400473', '263777104765');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("263718095555")){
  if(isReact) return
  m.react("💙")
   }
  //==========public react============//
